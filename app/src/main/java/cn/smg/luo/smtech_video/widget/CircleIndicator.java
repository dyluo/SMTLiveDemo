package cn.smg.luo.smtech_video.widget;
...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mIndicatorBackgroundResId = R.drawable.banner_shape_point_select;
    private int mIndicatorUnselectedBackgroundResId = R.drawable.banner_shape_point_normal;
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.scale_with_alpha, 0, R.drawable.banner_shape_point_select, R.drawable.banner_shape_point_normal);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.banner_shape_point_normal
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
    ...
    public void onPageSelected(int position) {
        ...
        currentIndicator.setAlpha(0.5f);
    ...
    private void addIndicator(@DrawableRes int backgroundDrawableId, Animator animator) {
        ...
        //```````````````设置透明度
        if(backgroundDrawableId == mIndicatorUnselectedBackgroundResId){
